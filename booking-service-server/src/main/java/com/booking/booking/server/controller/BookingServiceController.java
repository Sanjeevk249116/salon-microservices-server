...
public class BookingServiceController {
    ...
    public ResponseEntity<BookingService> createNewServiceBooking(@RequestBody BookingServiceDto newBookingServiceData) {
    ...
    @GetMapping("/read/list-customer/{customerId}")
    public ResponseEntity<List<BookingService>> getBookingByCustomer(@PathVariable Long customerId) {
        List<BookingService> getALlBookingByCustomer = bookingService.getAllBookingByCustomer(customerId);
    ...
    public ResponseEntity<BookingService> updateSingleBookingById(@PathVariable Long bookingId, @RequestBody BookingServiceDto updateBookingStatus) {
